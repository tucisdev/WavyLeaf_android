...
public class LoginContinued extends SherlockActivity
{
    ...
    protected void init()
    {
        ...
        ArrayAdapter<CharSequence> educationAdapter =
                ArrayAdapter.createFromResource(this, R.array.education_array, android.R.layout.simple_spinner_item);
        educationAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        education.setAdapter(educationAdapter);

        // For Outdoor Experience
        ArrayAdapter<CharSequence> experienceAdapter =
                ArrayAdapter.createFromResource(this, R.array.experience_array, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> confidence_plantAdapter = ArrayAdapter
                .createFromResource(this, R.array.confidence_plant_array, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> confidence_wavyleafAdapter = ArrayAdapter
                .createFromResource(this, R.array.confidence_wavyleaf_array, android.R.layout.simple_spinner_item);
