...
{
    // Used for calling dialogs; arbitrary numbers
    private static final int LEGAL = 1, HELP_TREATMENT = 2, HELP_PERCENT = 3, NO_GPS = 4;
    ...
    protected void init()
    {
        ...
        etarea.addTextChangedListener(new TextWatcher()
        {
            public void onTextChanged(CharSequence s, int start, int before, int count)
            {
                ...
                else if (etarea.getText().toString().contains("-"))
                { // Negative number
        ...
        ArrayAdapter<CharSequence> adapter =
                ArrayAdapter.createFromResource(this, R.array.areainfested_array, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sp.setAdapter(adapter);

        // Adapter for Treatment spinner
        ArrayAdapter<CharSequence> adapter2 =
                ArrayAdapter.createFromResource(this, R.array.treatment_array, android.R.layout.simple_spinner_item);
...
//        	Toast.makeText(getApplicationContext(), String.valueOf(currentEditableLocation.getTime()), Toast.LENGTH_SHORT).show();
                if (isAccurateLocation(currentEditableLocation))
                {//if LocationListener is accurate
