...
//		}
    ...
    public void onClick(View view)
    {
        ...
        else if (view == this.bu_trip)
        {
            ...
            if (sp.getBoolean(Settings.TRIP_ENABLED_KEY, false) == false)
            { // if user wants to start a new trip
                showDialog(ONSTART);
            ...
            else if (sp.getBoolean(Settings.TRIP_ENABLED_KEY, false) == true)
            { // If trip already in session
...
//	}
    ...
    protected void determineTallys()
    {
        ...
        sb.setSpan(fcsBlack, sb.toString().indexOf("/"), sb.toString().indexOf("/") + 1,
